...
public class ByteUtil {
	 ...
	 * @return 转换完成的字符串
	 */
	public static String byteArrayToHexString(byte[] array, boolean toPrint,int len) {
		if (array == null) {
			return "null";
		}
	...
	public static String byteArrayToHexString(byte[] array) {
		return byteArrayToHexString(array, false, 0);
	}
	...
	public static String binaryToDecimal(String binary){
		return String.valueOf(Integer.valueOf(binary,2));
	}

	public static String decimalToBinary(int decimal){
		String temp = Integer.toBinaryString(decimal);
		return String.format("%08d", Integer.valueOf(temp));
	}
}